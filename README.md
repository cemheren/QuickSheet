...
![Extensions](https://img.shields.io/badge/extensions-90%2B-orange)
...
- **Live data.** Column sums, sparklines, inline subprocesses (`i: top`), and 90+ extensions for weather, stocks, RSS, system monitoring, and more.
