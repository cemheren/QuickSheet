...
| `mcal:` | Mini month calendar — renders a text month grid with today highlighted. `mcal:` · `mcal: 2026-03` · `mcal: next` · `mcal: prev`. Zero network. | `ext: github:cemheren/quicksheet-cal-ext` |
