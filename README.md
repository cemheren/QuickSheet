...
![Extensions](https://img.shields.io/badge/extensions-80%2B-orange)
...
- **Live data.** Column sums, sparklines, inline subprocesses (`i: top`), and 80+ extensions for weather, stocks, RSS, system monitoring, and more.
