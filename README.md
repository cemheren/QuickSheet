...
| `rss:` | RSS/Atom feed reader — live headlines on your desktop. `rss: https://hnrss.org/newest?points=50` · multi-feed via file. No API key. | `ext: github:cemheren/quicksheet-rss-ext` |
