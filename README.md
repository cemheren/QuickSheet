...
| `sys:` | Live system monitoring — CPU per-core with bars, RAM/swap breakdown, disk usage, network I/O, load average, top processes. Full `/proc` support on Linux. | `ext: github:cemheren/quicksheet-sysmon` |
