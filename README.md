...
| `moon:` | Live lunar phase — emoji, name, illumination %, moon age. `moon:` (today) · `moon: 2026-12-25` · `moon: next full` · `moon: next new`. Fully offline, zero API key, deterministic. | `ext: github:Deskworks/quicksheet-moon-ext` |
