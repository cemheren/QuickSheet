...
| `unit:` | Unit conversion — `unit: 5 km to miles` · `unit: 100 F to C` · `unit: 1 GB to MB`. Length, mass, temperature, volume, speed, data, area, time. Zero network. | `ext: github:cemheren/quicksheet-unit-ext` |
