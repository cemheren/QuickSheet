...
![Extensions](https://img.shields.io/badge/extensions-85%2B-orange)
...
- **Live data.** Column sums, sparklines, inline subprocesses (`i: top`), and 85+ extensions for weather, stocks, RSS, system monitoring, and more.
