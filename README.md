...
![Extensions](https://img.shields.io/badge/extensions-71%2B-orange)
...
- **Live data.** Column sums, sparklines, inline subprocesses (`i: top`), and 71+ extensions for weather, stocks, RSS, system monitoring, and more.
