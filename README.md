...
| `case:` | US case law lookup — search by citation or keywords via CourtListener. `case: Roe v Wade` · `case: 410 U.S. 113` · `case: "fourth amendment" search`. No API key. | `ext: github:cemheren/quicksheet-case-ext` |
