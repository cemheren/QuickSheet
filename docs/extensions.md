...
| `hash`    | Hash Generator    | Generate MD5, SHA1, SHA256, SHA512, CRC32 hashes from text or file paths. `hash: sha256 hello world` · `hash: md5 /path/to/file` · `hash: crc32 quick check`. Offline, zero NuGet. | [`quicksheet-hashgen`](https://github.com/cemheren/quicksheet-hashgen) |
