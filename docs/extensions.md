...
| `mcal`    | Month Calendar    | Mini text month-view calendar with today highlighted. `mcal:` (current month), `mcal: 2026-03`, `mcal: next`, `mcal: prev`. Zero network, zero NuGet. | [`quicksheet-cal-ext`](https://github.com/cemheren/quicksheet-cal-ext) |
