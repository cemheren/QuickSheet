...
| `tz`      | Timezone Converter | Convert a specific time across zones — `tz: 3pm EST` shows UTC/London/Berlin/Tokyo/Sydney | [`quicksheet-tz-ext`](https://github.com/cemheren/quicksheet-tz-ext) |
