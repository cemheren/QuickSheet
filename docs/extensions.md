...
| `pubmed`  | PubMed Lookup     | PubMed article lookup by PMID or keyword search — title, authors, journal, year, DOI, abstract snippet. Free NCBI API. | [`quicksheet-pubmed`](https://github.com/cemheren/quicksheet-pubmed) |
