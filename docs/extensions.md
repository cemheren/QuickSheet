...
| `words`   | Text Analysis     | Word count, reading time, readability grade, character count, sentence/paragraph count, word frequency. For writers & bloggers. | [`quicksheet-words`](https://github.com/cemheren/quicksheet-words) |
