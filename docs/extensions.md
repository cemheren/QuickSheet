...
| `unit` | Unit Conversion | Instant unit conversion — length, mass, temperature, volume, speed, data, area, time. `unit: 5 km to miles` · `unit: 100 F to C` · `unit: 1 GB to MB`. Pure computation, zero network. | [`quicksheet-unit-ext`](https://github.com/cemheren/quicksheet-unit-ext) |
