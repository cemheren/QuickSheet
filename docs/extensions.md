...
| `pw`      | Password Generator | Secure password/PIN/hex/passphrase generator. CSPRNG-backed, entropy indicator, zero network. `pw: 24 alpha` (alphanumeric), `pw: pin 8`, `pw: 5 words` (passphrase). | [`quicksheet-pw-ext`](https://github.com/cemheren/quicksheet-pw-ext) |
