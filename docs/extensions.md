...
| `cve`     | CVE Lookup        | CVE vulnerability lookup via NIST NVD — severity 🔴🟠🟡🟢, CVSS score, description, affected products, publish date. Usage: `cve: CVE-2024-3094` · `cve: CVE-2021-44228`. 30-min cache, no API key, zero NuGet. | [`quicksheet-cve-ext`](https://github.com/cemheren/quicksheet-cve-ext) |
